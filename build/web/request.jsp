<html>
 ...
 .divtheme
    ...
    <body background="media/Picture0.jpg" class="divtheme" >
                      <form action="requestjavacode.jsp" method="post" >
           <table align="center" cellspacing="25px" cellpadding="5px" style="background-color: rgba(95,75,67,0.5); margin-top:100px; width: 500px;" >
               <tr align="center" style="font-size: 30px; font-weight: bold;font-style: italic;">
                   <td colspan="2">APPOINTMENT FORM</td>
               </tr>
                              <tr>
               ...
               <tr>
                   <td class="columntheme">Request</td>
