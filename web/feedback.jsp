<html>
 ...
 .divtheme
    ...
    <body background="media/Picture0.jpg" class="divtheme" >
        <form action="feedbackjavacode.jsp" method="post" >
           <table align="center" cellspacing="25px" cellpadding="5px" style="background-color: rgba(95,75,67,0.5); margin-top:100px; width: 500px;" >
               ...
               <tr>
                   <td class="columntheme">Feedback</td>
                   <td ><textarea class="placetheme" name="request" placeholder="Enter your feedback here" required ></textarea></td>
               </tr>
                 <tr>
                   <td class="columntheme">Rating</td>
                   <td ><input type="text" name="rat" placeholder="Enter tailor ratings here" class="placetheme" required ></td>
               </tr>
               <tr align="center">
